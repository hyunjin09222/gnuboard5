...
<head>
    ...
    if (isset($_GET['req']) && (($_GET['req'] == 'lineup'))) {
        ...
        $meta_title = get_meta_title($t_name, $opponent);
        $meta_desc = get_meta_description($datetime, $location);
        ?>
    ...
    echo '<link rel="stylesheet" href="' . run_replace('head_css_url', G5_THEME_CSS_URL . '/' . 'mobile' . $shop_css . '.css?ver=' . G5_CSS_VER, G5_THEME_URL) . '">' . PHP_EOL;
    ?>
